...
CREATE OR REPLACE FUNCTION growth_orient_offer (first_date TIMESTAMP,
                                                last_date TIMESTAMP,
                                                additional_transactions NUMERIC,
                                                churn_index FLOAT,
...
reward_group AS (
    ...
    SELECT rg.customer_id,
        ...
        nt.amount_transaction AS required_transactions_count,
        sg.group_name::varchar,
        ROUND(rg.min_discount * 100) AS offer_discount_depth
...
-- Проверка
SELECT * FROM growth_orient_offer ('2024-01-11', '2024-01-25', 1, 2.0, 80.0, 50.0);
SELECT * FROM growth_orient_offer ('2022-08-18', '2022-08-18', 1, 3.0, 70.0, 30.0);
SELECT * FROM growth_orient_offer ('2024-01-11', '2024-01-25', 1, 5.0, 100.0, 100.0);
SELECT * FROM growth_orient_offer ('2022-08-18', '2022-09-18', 1, 3.0, 70.0, 30.0);
SELECT * FROM growth_orient_offer ('2022-08-18', '2022-10-18', 1, 3.0, 70.0, 30.0);
